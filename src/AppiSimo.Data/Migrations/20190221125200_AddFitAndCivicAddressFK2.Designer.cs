...
namespace AppiSimo.Data.Migrations
{
    ...
    [Migration("20190221125200_AddFitAndCivicAddressFK2")]
    partial class AddFitAndCivicAddressFK2
    {
            ...
            modelBuilder.Entity("AppiSimo.Shared.Model.CivicAddress", b =>
                {
                    b.HasOne("AppiSimo.Shared.Model.User", "User")
                        .WithOne("CivicAddress")
                        .HasForeignKey("AppiSimo.Shared.Model.CivicAddress", "UserId")
            ...
            modelBuilder.Entity("AppiSimo.Shared.Model.Fit", b =>
                {
                    b.HasOne("AppiSimo.Shared.Model.User", "User")
                        .WithOne("Fit")
                        .HasForeignKey("AppiSimo.Shared.Model.Fit", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
